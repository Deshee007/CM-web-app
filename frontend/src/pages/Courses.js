...
useEffect(() => {
  ...
  return (
    ...
    <div className="container py-5 px-3">
      <div className="row">
        <div className="col-12 pb-3"><h2>Courses</h2></div> 
          ...
          <div className="row  d-flex">
            ...
            <div className="form-group d-flex">
              ...
              <div className="col-auto form-group d-flex">
               ...
               <div className="row d-flex justify-content-end">
              <div className="col-auto form-group d-flex">
                <Link to="/add_course" className="btn btn-outline-success">ADD</Link>
              </div>
            ...
            <table className="table text-center bg-light text-dark">
              <thead className="bg-gray">
                <tr>
                  ...
                  <th  className="border">Discipline</th> 
              ...
              <tbody  className="border">
                {dataObj.map((val, key) => {
                    return(
                        ...
                        <tr key={key}>
                          <td className="border">{val.course_name}</td>
                          <td className="border">{val.course_code}</td>
                          <td className="border">{val.discipline_code}</td>
                          <td className="border"><Link to={"/course?id="+val.id}><i className="text-danger fa fa-cog fa-2x" aria-hidden="true"></i></Link></td>
                        </tr>
