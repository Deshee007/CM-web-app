...
export default function Engineering_disciplines() {
  const [dataObj,setDataObj] = useState([])
  

useEffect(() => {

    fetch('http://localhost:8000/disciplines/').then(res=>res.json().then(data=>{
      setDataObj(data)
  ...
  return (
    ...
    <div className="container py-5 px-3">
      <div className="row">
        <div className="col-12 pb-3"><h2>Engineering Discipline</h2></div> 
          ...
          <div className="row  d-flex">
            ...
            <div className="col">
              ...
              <div className="col-auto form-group d-flex">
               ...
               <div className="row d-flex justify-content-end">
              <div className="col-auto form-group d-flex">
                <Link to="/add_discipline/" className="btn btn-outline-success">ADD</Link>
              </div>
              ...
              <tbody  className="border">
                {dataObj.map((val, key) => {
                    return(
                        ...
                        <tr key={key}>
                          <td className="border">{val.discipline_name}</td>
                          <td className="border"><Link to={"/discipline?id="+val.id}><i className="text-danger fa fa-cog fa-2x" aria-hidden="true"></i></Link></td>
                        </tr>
