...
useEffect(() => {
    ...
    fetch('http://localhost:8000/study_materials/').then(res=>res.json().then(data=>{
  ...
  return (
    ...
    <div className="container py-5 px-3">
      ...
      <div className="row">
        <div className="col-12 pb-3"><h2>Study materials</h2></div> 
          ...
          <div className="row  d-flex">
            ...
            <div className="col">
              ...
              <div className="col-auto form-group d-flex">
               ...
               <div className="row d-flex justify-content-end">
              <div className="col-auto form-group d-flex">
                <Link to="/add_study_material" className="btn btn-outline-success">ADD</Link>
              </div>
            ...
            <table className="table text-center bg-light text-dark">
              <thead className="bg-gray">
                <tr>
                  ...
                  <th  className="border">Material type</th>
                ...
                {dataObj.map((val, key) => {
                    return(
                        ...
                        <tr key={key}>
                          ...
                          <td className="border">{val.material_type}</td>
                          <td className="border"><Link to={"/study_material?id="+val.id}><i className="text-danger fa fa-cog fa-2x" aria-hidden="true"></i></Link></td>
                        </tr>
